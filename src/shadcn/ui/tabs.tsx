...
function TabsList({
  ...
  & VariantProps<typeof TABS_LIST_VARIANTS>) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
...
export { Tabs, TabsList, TabsTrigger, TabsContent, TABS_LIST_VARIANTS as tabsListVariants };
